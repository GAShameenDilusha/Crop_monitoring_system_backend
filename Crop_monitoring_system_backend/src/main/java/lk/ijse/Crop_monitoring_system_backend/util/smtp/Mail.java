package lk.ijse.Crop_monitoring_system_backend.util.smtp;
    ...
    public void outMail() throws MessagingException {
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("pererairosh6@gmail.com", "zizvnhazyssiexuc");  // have to change some settings in SMTP
            }
        });
